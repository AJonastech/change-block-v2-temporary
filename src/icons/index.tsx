...
export const VersionIcon = () => {
  return <Image src="/icons/version.svg" width={20} height={20} alt="T" />;
};
export const AddUserIcon = () => {
  return <Image src="/icons/add-user.svg" width={20} height={20} alt="T" />;
};
...
export const RefreshIcon = () => {
   return <Image src="/icons/refresh.svg" width={22} height={13} alt="T" />;
...
export const ShareIcon = () => {
  return <Image src="/icons/share.svg" width={22} height={13} alt="T" />;
};
